...
import cl.tidev.commons.library.json.JsonParser;
...
public class JsonView extends View{
	...
	public void prepareResponse(Map<?,?> map) {
		if( map != null) jsonResponse.append( JsonParser.parseMap(map) );
		else emptyResponse();
	}
	...
	public void render(HttpServletResponse response) {
	    ...
	    try {
	    	Logger.getLogger( this.getClass() ).debug( jsonResponse.toString() );
	...
	public void render(HttpServletResponse response, String strResponse) {
	    ...
	    try {
	    	Logger.getLogger( this.getClass() ).debug( strResponse );
	...
	public void prepareResponse(Object object) {
		if( object != null) prepareResults(true, JsonParser.parseClass(object));
		else prepareMessageResponse(false, "Datos no encontrados!");
	}
